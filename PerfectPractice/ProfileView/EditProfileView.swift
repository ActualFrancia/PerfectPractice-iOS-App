...
#Preview {
    ...
    let name = "Jeff"
    let pfp = UIImage(named: "DefaultPFP")?.pngData()
    let defIns = ""
    
    let user1 = User(name: name, pfp: pfp, primaryInstruments: [], secondaryInstruments: [], defaultInstrument: defIns)
